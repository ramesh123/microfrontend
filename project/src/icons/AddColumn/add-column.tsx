...
export const AddColumnIcon = ({ size = 24, color = 'currentColor', className, ...props }) => ( 
    <svg xmlns="http://www.w3.org/2000/svg" className={cn(className)} width="200" height="200" viewBox="0 0 90.000000 90.000000" preserveAspectRatio="xMidYMid meet" {...props}>
