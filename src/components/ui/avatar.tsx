...
// MD3/@material/web has no avatar component — this is a plain, standard
// image-with-fallback implementation. Root still walks its children once to
// pull src/alt/fallback out of <AvatarImage>/<AvatarFallback>, preserving the
// existing call-site shape (<Avatar><AvatarImage .../><AvatarFallback>...</AvatarFallback></Avatar>).
