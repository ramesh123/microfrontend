...
export const SourceSelection = ({ sources, onToggleSource, onReorderSources, onSave, onCancel, isLoading, mode }: SourceSelectionProps) => {
      ...
      <div className="flex flex-wrap gap-1.5 items-center">
        ...
        {onSave && onCancel && (
          <div className="flex gap-2 ml-auto">
            ...
            <Button onClick={onSave} disabled={isLoading || mode === 'view'} size="sm" className='disabled:cursor-not-allowed'>
              {isLoading ? (
                <>
