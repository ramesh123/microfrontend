...
import nwayDataValidationStore from '@/stores/nwayvalidationstore';
...
function NWayValidation(mode: {mode: 'view' | 'edit'}) {
  const { initializeState, reset } = nwayDataValidationStore();
        ...
        <div className="flex h-full items-center justify-center">
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              Please select a "Data Validation" node in the flow to configure it.
            </p>
          </div>
        </div>
      )}
