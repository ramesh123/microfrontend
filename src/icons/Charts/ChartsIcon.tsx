...
export const ChartsIcon = ({ className, ...props }: any) => (
  <svg fill="currentColor" width="256" height="256" className={className} viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg">
