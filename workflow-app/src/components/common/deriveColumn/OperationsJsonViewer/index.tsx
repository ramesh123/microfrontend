...
import { AppliedOperation } from '@/types/deriveColumn';
...
export const OperationChainJsonViewer: React.FC<OperationChainJsonViewerProps> = ({ operations, selectedColumn }) => {
